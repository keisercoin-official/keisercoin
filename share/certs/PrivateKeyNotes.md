...
unlocked to sign the Keisercoin-Qt.app bundle.
...
allowing somebody to distribute a Keisercoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the keisercoin-qt.exe file inside the installer had not been tampered with.
